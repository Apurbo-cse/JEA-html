@include('layouts.frontend.header')
 ...
 <div class="page-header">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 style="font-size: 20px;">BSc in Engineering <span style="font-size: 14px;">(Diploma
                            Holders)</span> </h2>
                </div>
                <div class="col-12">
                    ...
                    <div class="class-wrap"><br>
                        <div class="class-text">
                            <div class="class-teacher">
                                <img src="{{asset('frontend/images/bappy.jpg')}}" alt="Image">
                                <h3>S.M Bappy Reza</h3>
                                <a href="{{route('profiles')}}">+</a>
                            </div>
                            <h2 style="font-size: 13.5px;">Civil Engineer & CEO </h2>
                            <div class="class-meta">
                                <p><i class="far fa-location-alt"></i>Azaan, Joypurhat-5900</p>
                            </div>
                        </div>
                    </div>
                </div>
