    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">List Of Silder</h4>
                <ol class="breadcrumb pull-right">
                    <li><a href="/dashboard">Dashboard</a></li>
                    <li class="active">Silder List</li>
                </ol>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Silder List</h3>
                </div>
                <div class="panel-body">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width: 12%">Detailes</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div style="width:70px; height:50px;overflow:hidden">
                                        <img src="{{ asset($blog->image) }}" style="width:60px; height:40px;overflow:hidden;" class="" alt="">
                                    </div>
                                </td>
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('blog.show', $blog->id) }}">Details</a>
                                   
                                </td>
                                <td class="d-flex">
                                    <a class="btn btn-info d-inline-block" href="{{ route('blog.edit', $blog->id) }}">Edit</a>
                                    <form class="d-inline-block pull-right" method="post" action="{{ route('blog.destroy', $blog->id) }}">
                                        @csrf
                                        @method('delete')
