                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('about.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input value="{{old('title')}}" name="title" type="text" id="title" class="form-control" placeholder="About title">
                                @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea name="description" class="form-control" rows="5" placeholder="About Description">{{ old('description') }}</textarea>
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-10">
                                <textarea name="description" class="form-control" rows="1" placeholder="Our Mission">{{ old('mission') }}</textarea>
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea name="description" class="form-control" rows="1" placeholder="Our Vission">{{ old('vission') }}</textarea>
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea name="description" class="form-control" rows="1" placeholder="Our History">{{ old('history') }}</textarea>
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">About Status</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">About Image</label>
                            <div class="col-md-10">
