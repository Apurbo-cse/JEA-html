                    ...
                    <aside class="sidebar default-sidebar">
                                        ...
                                        <div class="tab-pane fade show active" id="latest-news">
                                            ...
                                            <div class="post post-small post-list education-post post-separator-border">
                                                <div class="postwrap">
                                                    ...
                                                    <!-- Image -->
                                                    <a class="image" href="post-details.html"><img src="{{asset('images/bonomaya.jpg')}}" alt="post"></a>
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <!-- Title -->
                                                        <h5>
                                                            <a href="post-details.html">Bonomaya at Daffodil
                                                                International
                                                                University</a>
                                                        </h5>
                                            ...
                                            <div class="post post-small post-list education-post post-separator-border">
                                                <div class="postwrap">
                                                    ...
                                                    <!-- Image -->
                                                    <a class="image" href="post-details.html"><img src="{{asset('images/know.jpg')}}" alt="post"></a>
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <!-- Title -->
                                                        <h5>
                                                            <a href="post-details.html">Knowledge Valley at Daffodil
                                            ...
                                            <div class="post post-small post-list education-post post-separator-border">
                                                <div class="postwrap">
                                                    ...
                                                    <!-- Image -->
                                                    <a class="image" href="post-details.html"><img src="{{asset('images/ino.jpg')}}" alt="post"></a>
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <!-- Title -->
                                                        <h5>
                                                            <a href="post-details.html">The largest inovation lab in
                                                                Private
                        ...
                        <div class="sidebar-widget facebook-widget">
                            ...
                            <div class="widget-content">
                                <div class="image">
                                    <a href="https://www.facebook.com/diutransport" target="_blank"><img src="{{asset('images/buspage.jpg')}}" style="
                                                                                                                                         width: 100%;
                                                                                                                                         object-fit: cover;                                                                                                                                         " /></a>
                                </div>
                            </div>
